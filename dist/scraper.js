...
let getEdXSubjects = (() => {
    var _ref18 = _asyncToGenerator(function* (callback) {
    ...
    return function getEdXSubjects(_x24) {
        return _ref18.apply(this, arguments);
    };
})();

let getEdXCoursesForSubject = (() => {
    var _ref19 = _asyncToGenerator(function* (subject, callback) {
    ...
    return function getEdXCoursesForSubject(_x25, _x26) {
